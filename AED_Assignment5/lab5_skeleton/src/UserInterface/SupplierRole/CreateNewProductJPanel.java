...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 230, 110, 30));

        txtAvailibility.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(txtAvailibility, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 230, 160, 30));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String stringPrice = txtAvailibility.getText();
