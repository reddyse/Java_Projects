...
populateTable();
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
       ...
       JOptionPane.showMessageDialog(null, "Quantity can not be zero");
        ...
        {
               JOptionPane.showMessageDialog(null, "Quantity > Availbility","Warning", JOptionPane.WARNING_MESSAGE);
        }
...
if(newQty<=0)
{
JOptionPane.showMessageDialog(null, "Quantity has to be positive");
return;
...
String prodName=txtSearchKeyWord.getText();
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        OrderItem oi = (OrderItem)orderTable.getValueAt(row, 0);
        ViewOrderItemDetailJPanel vpd = new ViewOrderItemDetailJPanel(upc, oi);
        upc.add("ViewOrderItemDetailJPanel", vpd);
        CardLayout layout = (CardLayout) upc.getLayout();
        layout.next(upc);
