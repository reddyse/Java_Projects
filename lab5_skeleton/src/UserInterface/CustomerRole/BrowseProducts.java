...
private JPanel upc;
private SupplierDirectory supplydir;
private MasterOrderCatalog moc;
private Order order;
private boolean ischeckedout=false;
    /** Creates new form BrowseProducts */
public BrowseProducts(JPanel upc, SupplierDirectory supplydir, MasterOrderCatalog moc) {
        initComponents();
        this.upc=upc;
    ...
    public void populateSupplierCombo()
    {
         ...
         for(Supplier s: supplydir.getSupplierlist())
         {
        ...
        try
       {
        double salesPrice=Double.parseDouble(txtSalesPrice.getText());
                if(salesPrice<=selectedProduct.getPrice())
                        {
                         JOptionPane.showMessageDialog(null, "Sales Price cannot be less than equal to 0");
                          return;
                        }
                if(fetchqty<=selectedProduct.getAvail())
                        {
                         boolean alreadyPresent=false;
                          for(OrderItem oi : order.getOrderItemList())
                          {
                              ...
                              {
                                  JOptionPane.showMessageDialog(null, "Quantity>Availability. Order cannot be created.");
                              }
                              }
                          }
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Orderitem sucessfullly removed from the cart");
        refreshOrderTable();
        populateTable();
